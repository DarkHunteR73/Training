...
int main()
{
	std::vector<int> test{ 3, 8, 9, 7, 6 };
	std::vector<int> out = solution(test, 3);
}
...
//  that, given an array A consisting of N integersand an integer K, returns the array A rotated K times.
